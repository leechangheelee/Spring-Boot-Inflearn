  ...
  * 스프링 데이터 - MongoDB
    ...
    * 스프링 데이터 몽고DB
      ...
      * @DataMongoTest
        ...
        ...
        @RunWith(SpringRunner.class)
        @DataMongoTest // 몽고 리파지토리에 관련된 빈들만 등록됨
        public class AccountRepositoryTest {
            ...
            public void findByEmail() {
                ...
                Optional<Account> byEmail = accountRepository.findByEmail(account.getEmail());// 스프링 데이터 JPA 에서 쿼리 메소드로 쿼리를 구현하듯이 여기도 그렇게 할 수 있음
